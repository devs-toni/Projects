	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable()
				.authorizeRequests()
					...
					.antMatchers("/login","/perform-login","perform-oauth-login","/home","/login-error","/oauth2/authorization/facebook","oauth2/authorization/google","/index","/register","/process-register","/error").permitAll()
				.anyRequest()
					.authenticated()
					.and()
				.formLogin()
